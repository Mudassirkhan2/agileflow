        ...
        <div>
            <section className="flex flex-col py-20  items-center justify-center bg-[#28282B]">
                <div className="flex flex-col items-center justify-center pb-20 text-center ">
                    ...
                    />
                    <div
                        className="flex justify-center w-2/3 pb-20 text-6xl text-white md:text-6xl md:px-20 "
                    >
                        Try the #1 software in project and product management
                    </div>
                    <div className="flex items-center justify-center w-40 p-6 text-xl bg-white rounded-lg">
                        Get started
                    </div>
                </div>
                <div className="hidden pt-40 space-x-40 border-t md:flex ">
                    <div className="">
                        <Image
