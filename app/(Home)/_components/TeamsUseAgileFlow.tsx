    ...
    return (
        <div ref={ref}
                ...
                <div
                    ...
                    <div className="space-y-10">
                        ...
                        <div className="flex items-center space-x-8 text-xl hover:text-blue-500">
                            See how customers use AgileFlow
            ...
            <motion.div
                ...
                className="hidden py-20 pt-10 text-4xl md:text-6xl md:block">See how teams use AgileFlow
            </motion.div>
            <div>
            </div>
...
export default TeamsUseAgileFlow
